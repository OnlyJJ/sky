...
public class SysResult {
	 ...
	 * 如果没有返回值的优先采用系统常量
	 */
    public static final int SUCCESS = 200; // 成功 -通用
    public static final int FAULT = 500; // 失败-通用
    public static final int USER_UN_LOGIN = 501; // 失败-用户未登录
    
    
    //以下常量主要针对json结构使用     定义jackson对象
